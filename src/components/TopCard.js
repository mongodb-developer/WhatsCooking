...
const TopCard = ({name, idx, setIndex, borough, cuisine, address, score, reviews, price, stars, sponsored, setShowMenu, source, functionScore }) =>{
        ...
        <React.Fragment>
                ...
                { source === "Top3" ?   
                   ...
                   <div className="flex my-auto mt-2 mb-0 BOTTOM ROW justify-evenly "> 
                        <div className="flex justify-center transition duration-700 transform hover:scale-150">         
                        ...
                        <div className="flex justify-center transition duration-700 transform hover:scale-150">
                        {dollars.map(dollar =>
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-4xl text-green-700" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <h2 className="text-sm transition duration-700 transform hover:scale-150">{reviewCount} reviews</h2>
                    </div>
